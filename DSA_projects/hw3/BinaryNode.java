class BinaryNode<T>
{
   ...
   {
	   // ensures that node being traversed is not null
	   if(data == null)
		   return;
	   if(leftChild != null)
	   {
   ...
   {   	
	   //sets heights of left and right subtree to 0
	   int left = 0;
	   int right = 0;
	   ...
	   else
	   {
		   ...
		   //returns subtree with the greatest height and adds one to account for the node itself
